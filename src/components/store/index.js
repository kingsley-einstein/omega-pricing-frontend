...
export default class Store extends Component {
  ...
  handleEdit = async () => {
    ...
    const editBody = {
      ...
      store: this.state.submittable.store
    };
    ...
    return (
      <div>
        <div style={styles.flexDiv}>
          ...
          <AddOrEdit editEnabled={this.state.editMode} handleChange={this.handleChange} preEdit={this.state.submittable} handleSubmit={this.handleSubmit} handleEdit={this.handleEdit} stores={this.state.stores} />
          <div>
